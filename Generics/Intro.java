...
public class Intro {
    // 1.
    // reusing the same code for different types of input or different data types

    // for example list can also store the integer and on the other hand list can
    ...
    // when we have to use the same code for different data types then we use the
    // generic
